    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('user-posts-new') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="content" id="content" cols="30" rows="10" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" required>{{ old('content') }}</textarea>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a class="btn btn-danger" href="{{ route('user-posts-list') }}" enctype="multipart/form-data">
                                        {{ __('Cancelar') }}
                                    </a>
                                </div>
                            </div>
